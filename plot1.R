...
# This script follows a step-by-step procedure to construct plot1.png for the Exploratory Data Project (week 1)
...
# Create plot1 on screen

hist(analysedData$Global_active_power, col= "red", main ="Global Active Power", xlab ="Global Active Power (kilowatts)")
